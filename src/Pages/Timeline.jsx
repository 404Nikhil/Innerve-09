              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                ...
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded shadow">
                  <div className="flex items-center justify-between space-x-2 mb-1">
                    ...
                    <time className="font-caveat font-medium text-gray-400">5 Dec, 2024</time>
                  </div>
                  <div className="text-slate-500">Secure your spot starting December 5, 2024, at 12:00 AM
